        ...
        >
          ...
          >
            <div style={{ flex: 3 }}>
              ...
              <button
                onClick={() => setSelectedNetwork(Network.polygon)}
                style={{ background: selectedNetwork === Network.polygon ? 'purple' : 'none' }}
              >
                Polygon Mainnet
              </button>
              <button
                onClick={() => setSelectedNetwork(Network.mumbai)}
                style={{ background: selectedNetwork === Network.mumbai ? 'purple' : 'none' }}
              >
