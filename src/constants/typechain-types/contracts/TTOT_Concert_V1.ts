...
export interface TTOT_Concert_V1Interface extends utils.Interface {
  functions: {
...
export interface TTOT_Concert_V1 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TTOT_Concert_V1Interface;
